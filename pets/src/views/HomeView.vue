<template>
  <div class="vue-tempalte">
   <nav class="d-flex navbar shadow bg-white rounded flex-nowrap flex-row fixed-top">
      <div class="col-10">
...
<style>@import url(https://fonts.googleapis.com/css?family=Roboto:400,100,900);
